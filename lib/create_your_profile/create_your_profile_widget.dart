...
class _CreateYourProfileWidgetState extends State<CreateYourProfileWidget> {
  ...
  void initState() {
    super.initState();
    bioController = TextEditingController(text: 'IASD ');
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> createYourProfileUsersRecordList = snapshot.data;
        // Return an empty Container when the document does not exist.
        if (snapshot.data.isEmpty) {
          return Container();
        }
        final createYourProfileUsersRecord =
        createYourProfileUsersRecordList.isNotEmpty
            ? createYourProfileUsersRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                            ...
                            child: Container(
                              ...
                              child: Image.network(
                                valueOrDefault<String>(
                                  createYourProfileUsersRecord.photoUrl,
