                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<List<AuroraMusicaRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          listViewAuroraMusicaRecordList = snapshot.data;
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewAuroraMusicaRecordList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewAuroraMusicaRecord =
                              listViewAuroraMusicaRecordList[listViewIndex];
                              return Padding(
                                padding:
                                ...
                                child: ExpandablePanel(
                                  ...
                                  expanded: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0, 5, 0, 0),
                                    child:
                                    StreamBuilder<List<AuroraMusicaRecord>>(
                                      stream: queryAuroraMusicaRecord(
                                        queryBuilder: (auroraMusicaRecord) =>
                                            auroraMusicaRecord
                                                .where('ativo',
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return Padding(
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      DeleteMusicaWidget(
                                                                        auroraMusica:
                                                                        columnAuroraMusicaRecord.reference,
                                                                      ),
                                                                    ),
                                                                  );
                                                                },
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                valueOrDefault<String>(
                                                                                  dateTimeFormat('EEEE', columnAuroraMusicaRecord.data),
                                                                                  'S/ Dia',
                                                                                ),
                                                                                style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                  fontFamily: 'Advent Sans',
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            AutoSizeText(
                                                                              valueOrDefault<String>(
                                                                                columnAuroraMusicaRecord.whatsapp,
                                                                                'S/ Whats',
                                                                              ),
                                                                              style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                fontFamily: 'Advent Sans',
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              valueOrDefault<String>(
                                                                                columnAuroraMusicaRecord.igreja,
                                                                                'S/ Igreja',
                                                                              ).maybeHandleOverflow(
                                                                                maxChars: 20,
                                                                                replacement: '…',
