                    ...
                    child: Padding(
                      ...
                      child: StreamBuilder<List<AuroraLimpezaRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          listViewAuroraLimpezaRecordList = snapshot.data;
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewAuroraLimpezaRecordList.length,
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return Padding(
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      DeleteLimpezaWidget(
                                                                        auroraLimpeza:
                                                                        columnAuroraLimpezaRecord.reference,
                                                                      ),
                                                                    ),
                                                                  );
                                                                },
                                                                            ...
                                                                            Expanded(
                                                                              child: Text(
                                                                                valueOrDefault<String>(
                                                                                  columnAuroraLimpezaRecord.nome,
                                                                                  'S/ Nome',
                                                                                ).maybeHandleOverflow(
                                                                                  maxChars: 20,
                                                                                  replacement: '…',
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                valueOrDefault<String>(
                                                                                  dateTimeFormat('EEEE', columnAuroraLimpezaRecord.data),
                                                                                  'S/ Dia',
                                                                                ),
                                                                                style: FlutterFlowTheme.of(context).bodyText1.override(
                                                                                  fontFamily: 'Advent Sans',
