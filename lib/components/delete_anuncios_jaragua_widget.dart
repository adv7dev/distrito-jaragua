...
class DeleteAnunciosJaraguaWidget extends StatefulWidget {
  const DeleteAnunciosJaraguaWidget({
    Key key,
  ...
  @override
  _DeleteAnunciosJaraguaWidgetState createState() =>
      _DeleteAnunciosJaraguaWidgetState();
}

class _DeleteAnunciosJaraguaWidgetState
    extends State<DeleteAnunciosJaraguaWidget> {
  @override
