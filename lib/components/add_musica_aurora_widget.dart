...
class AddMusicaAuroraWidget extends StatefulWidget {
  const AddMusicaAuroraWidget({Key key}) : super(key: key);

  @override
  _AddMusicaAuroraWidgetState createState() => _AddMusicaAuroraWidgetState();
}

class _AddMusicaAuroraWidgetState extends State<AddMusicaAuroraWidget> {
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        await AuroraMusicaRecord.collection
                            .doc()
                            .set(auroraMusicaCreateData);
