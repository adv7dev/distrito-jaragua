...
class DeletePregadoresWidget extends StatefulWidget {
  const DeletePregadoresWidget({
    ...
    this.panPregadores,
    this.auroraPregadores,
  }) : super(key: key);

  final DocumentReference jaraguapregadores;
  final DocumentReference ipanemaPregadores;
  final DocumentReference panPregadores;
  final DocumentReference auroraPregadores;
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    final panamericanoPregadoresUpdateData =
                                        createPanamericanoPregadoresRecordData(
                                      ativo: false,
                                    );
                                    await widget.panPregadores.update(
                                        panamericanoPregadoresUpdateData);
                                    Navigator.pop(context);
                                  },
                                  text: 'Enviar Para  o Histórico',
                                  options: FFButtonOptions(
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await widget.panPregadores.delete();
                                      Navigator.pop(context);
                                    },
                                    text: 'Deletar',
                                    options: FFButtonOptions(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    final auroraPregadoresUpdateData =
                                        createAuroraPregadoresRecordData(
                                      ativo: false,
                                    );
                                    await widget.auroraPregadores
                                        .update(auroraPregadoresUpdateData);
                                    Navigator.pop(context);
                                  },
                                  text: 'Enviar Para  o Histórico',
                                  options: FFButtonOptions(
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await widget.auroraPregadores.delete();
                                      Navigator.pop(context);
                                    },
                                    text: 'Deletar',
                                    options: FFButtonOptions(
