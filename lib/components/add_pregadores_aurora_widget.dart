...
class AddPregadoresAuroraWidget extends StatefulWidget {
  const AddPregadoresAuroraWidget({Key key}) : super(key: key);

  @override
  _AddPregadoresAuroraWidgetState createState() =>
      _AddPregadoresAuroraWidgetState();
}
