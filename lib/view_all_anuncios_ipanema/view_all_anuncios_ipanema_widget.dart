...
class ViewAllAnunciosIpanemaWidget extends StatefulWidget {
  const ViewAllAnunciosIpanemaWidget({Key key}) : super(key: key);

  @override
  _ViewAllAnunciosIpanemaWidgetState createState() =>
      _ViewAllAnunciosIpanemaWidgetState();
}

class _ViewAllAnunciosIpanemaWidgetState
    extends State<ViewAllAnunciosIpanemaWidget> {
                      ...
                      child: StreamBuilder<List<AnunciosIpanemaRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<AnunciosIpanemaRecord>
                              columnAnunciosIpanemaRecordList = snapshot.data;
                          return Column(
                            mainAxisSize: MainAxisSize.max,
                            children: List.generate(
                                columnAnunciosIpanemaRecordList.length,
                                (columnIndex) {
                              final columnAnunciosIpanemaRecord =
                                  columnAnunciosIpanemaRecordList[columnIndex];
                              return Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Expanded(
